...
class MotionPlanner:
    def __init__(self, node_name: str = "inspectra_moveit_py", group_name: str = "panda_arm"):
        ...
        self._moveit = MoveItPy(node_name=node_name, config_dict=moveit_config)
    ...
    def plan_to_pose(self, x: float, y: float, z: float,
        ...
        self._arm.set_goal_state(pose_stamped_msg=pose_goal, pose_link=pose_link)
        return self._plan()
    ...
    def execute(self, plan_result) -> bool:
        if not plan_result:
            ...
            return False
        self._logger.info("Executing planned trajectory...")
        self._moveit.execute(plan_result.trajectory, controllers=[])
        return True

    def plan_and_execute(self, config_name: str = None, joint_values: dict = None,
                          pose_xyz: tuple = None):
        ...
        if config_name is not None:
            ...
            raise ValueError("Provide one of: config_name, joint_values, pose_xyz")
